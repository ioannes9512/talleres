...
namespace NPC
{
    namespace EsPundead
    {
        ...
        /// <summary>
        /// en esta clase se declaran todas las variables que seran utilizadas para dar vida  al nuevo tipo de enemigo siendo este 
        /// en escencia una copia del primero aunque con alguans variaciones
        ...
        /// </summary>
        public sealed class Zombieesp : MonoBehaviour
        {
            public Hero daño;
            ...
            void Start()
            {
                ...
                StartCoroutine(seekingvictims());
                daño = GameObject.FindGameObjectWithTag("Hero").AddComponent<Hero>();
                followSpeed = 10 / edad;
            ...
            void Update()
            {
                ...
                //se crea un caso para cada estado cada caso contiene las acciones a seguir segun el estado que le corrsponda
                switch (Zombiestate)
                {
                    case State.Idle:
                        break;
            ...
            private void OnCollisionEnter(Collision collision)
            {
                ...
                {
                    collision.gameObject.AddComponent<Zombieesp>().zombiestats = collision.gameObject.GetComponent<NPC.Ally.Citizen>().citizenstats;
